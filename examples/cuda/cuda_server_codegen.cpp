// zlink/examples/cuda/cuda_server_codegen.cpp
//
// CUDA RPC server — CODEGEN-BASED, comprehensive coverage.
//
// Handles ALL 269+ CUDA Driver API functions from gen_api.hpp,
...
int main(int argc, char* argv[]) {
    std::cerr << "zlink CUDA RPC Server (codegen) v5.0\n";
    std::cerr << "  Covers 269+ CUDA Driver API functions\n";
